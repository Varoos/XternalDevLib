    ...
    public partial class frmPrePayment00 : Form
    {
        ...
        private void Load_List0()
        {
            try
            {
                ...
                string SQL = " Exec xsp_PrePayment_List '" + Convert.ToString(iStartDate) + "','" + Convert.ToString(iEndDate) + "'";
                dt = Xlib.GetDataTableAPI(SQL);
                gvList0.DataSource = dt;
            }
            catch (Exception ex)
            {
                Xlib.ErrLog(ex, this.Name + ".Load_List0()");
            }
        }
        ...
        private bool PrePayment_Posting(int iMasterId, int iStartDate, int iEndDate)
        {
            ...
            try
            {
                string SQL = " Exec xsp_PrePayment_Posting '" + Convert.ToString(iMasterId) + "','" + Convert.ToString(iStartDate) + "','" + Convert.ToString(iEndDate) + "'";
                    ...
                    if (dt_H.Rows.Count > 0)
                    {
                        ...
                        if (dt_B.Rows.Count > 0)
                        {
                            ...
                            if (response != null)
                            {
                                ...
                                {
                                    SQL = " Exec xsp_Update_PrePayment_PostedDate '" + iEndDate + "','" + iMasterId + "'";
