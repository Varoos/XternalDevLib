   ...
   public class CustomMsgBox : Form
    {
        ...
        private static CustomMsgBox _msgBox;
        ...
        public static void Show(string message, string title)
        {
            ...
            _msgBox.Size = CustomMsgBox.MessageSize(message);
            _msgBox.ShowDialog();
            MessageBeep(0);
        }
        ...
        public static DialogResult Show(string message, string title, Buttons buttons)
        {
            ...
            CustomMsgBox.InitButtons(buttons);
        ...
        public static DialogResult Show(string message, string title, Buttons buttons, Icon icon, AnimateStyle style)
        {
            ...
            _timer = new Timer();
            Size formSize = CustomMsgBox.MessageSize(message);

            switch (style)
            {
                case CustomMsgBox.AnimateStyle.SlideDown:
                    _msgBox.Size = new Size(formSize.Width, 0);
                    _timer.Interval = 1;
                    _timer.Tag = new AnimateMsgBox(formSize, style);
                    break;

                case CustomMsgBox.AnimateStyle.FadeIn:
                ...
                case CustomMsgBox.AnimateStyle.ZoomIn:
        ...
        private static void InitButtons(Buttons buttons)
        {
            switch (buttons)
            {
                case CustomMsgBox.Buttons.AbortRetryIgnore:
                    _msgBox.InitAbortRetryIgnoreButtons();
                    break;

                case CustomMsgBox.Buttons.OK:
                    _msgBox.InitOKButton();
                    break;

                case CustomMsgBox.Buttons.OKCancel:
                    _msgBox.InitOKCancelButtons();
                    break;

                case CustomMsgBox.Buttons.RetryCancel:
                    _msgBox.InitRetryCancelButtons();
                    break;

                case CustomMsgBox.Buttons.YesNo:
                    _msgBox.InitYesNoButtons();
                    break;

                case CustomMsgBox.Buttons.YesNoCancel:
    ...
    class AnimateMsgBox
    {
        ...
        public CustomMsgBox.AnimateStyle Style;

        public AnimateMsgBox(Size formSize, CustomMsgBox.AnimateStyle style)
        {
